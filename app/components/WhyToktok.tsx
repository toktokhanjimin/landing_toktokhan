...
const items = [
  { en: "처음부터 끝까지", ko: "9년동안 직접 해온 경험", desc: "기획, 디자인, 개발, 컨설팅, 런칭, 그로스까지 9년 동안 직접 해왔어요. 한 단계만 보는 게 아니라 전체 흐름을 알고 있어서, 어디서 막히고 어디서 효율이 나는지 미리 봐요.", visual: "endtoend" },
  { en: "조직 안에 심기", ko: "교육 인프라와 팀 내재화", desc: "AX는 도입하고 끝나면 의미가 없어요. 사내에 강사를 두고, 팀원들이 직접 쓸 수 있을 때까지 교육해요. HR 체계랑도 연결해서, 우리가 빠진 뒤에도 조직이 알아서 돌아가게 만들어요.", visual: "internalize" },
  { en: "우리가 만든 방법", ko: "먼저 설계하고 검증한 방법", desc: "다른 데서 쓰는 방법을 그대로 가져오지 않아요. 우리가 먼저 정의하고, 똑똑한개발자 안에서 써보고, 효과가 확인된 방법만 고객에게 적용해요.", visual: "method" },
  { en: "자체 서비스 출시 경험", ko: "아웃소싱은 물론 자체 서비스 출시 및 고도화 경험", desc: "자체 서비스를 직접 출시하고 운영해본 경험이 있어요. 그래서 서비스 런칭 이후의 비즈니스 흐름까지 같이 보면서, 더 체계적으로 분석하고 제안해드릴 수 있어요.", visual: "products" },
];
